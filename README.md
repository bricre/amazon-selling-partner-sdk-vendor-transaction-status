# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner API for Retail Procurement Transaction Status
...
```shell
composer require bricre/amazon-selling-partner-sdk-vendor-transaction-status
```
...
```php
<?php
use Amz\VendorTransactionStatus\ResponseTypes;
